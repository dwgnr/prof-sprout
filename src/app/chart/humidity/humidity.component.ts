...
export class HumidityComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.dataService.getHumidity(this.startTime, this.endTime, this.resolution, this.hours)
            .subscribe((result) => this.humidityData = result.data,
    ...
    createChart() {
        ...
        for (const datum of this.humidityData) {
    ...
    reload() {
        ...
        this.dataService.getHumidity(this.startTime, this.endTime, this.resolution, this.hours)
            .subscribe((result) => this.humidityData = result,
                (error) => this.handleError(error),
                () => this.createChart()
            );
    ...
    onChartChange(stepSize, displayDateFormat, resolution, hours) {
        ...
        this.hours = hours;
        this.dataService.getHumidity(this.startTime, this.endTime, this.resolution, this.hours)
            .subscribe((r) => this.humidityData = r.data,
                (error) => this.handleError(error),
                () => this.createChart()
            );
    }
